...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0x389";
}
}
"  s0  " -> "0x406" [style = solid];
"  s1  " -> "0x408" [style = solid];
"  s2  " -> "0x40a" [style = solid];
"  c3  " -> "0x40b" [style = solid];
"0x40a" -> "0x409";
"0x40a" -> "0x409" [style = dotted];
"0x40b" -> "0x390";
"0x40b" -> "0x409" [style = dashed];
"0x390" -> "0x389";
"0x390" -> "0x389" [style = dotted];
"0x408" -> "0x407";
"0x408" -> "0x407" [style = dotted];
"0x409" -> "0x3c2";
"0x409" -> "0x407" [style = dashed];
"0x3c2" -> "0x389";
"0x3c2" -> "0x389" [style = dotted];
"0x407" -> "0x3e1";
"0x407" -> "0x405" [style = dashed];
"0x406" -> "0x405";
"0x406" -> "0x405" [style = dotted];
"0x3e1" -> "0x389";
"0x3e1" -> "0x389" [style = dotted];
"0x405" -> "0x389";
"0x405" -> "0x389" [style = dotted];
"0x389" [label = "1"];
}
