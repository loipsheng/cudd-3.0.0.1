...
int main() {
    ...
    int result = system("dot -Tpng bdd2.dot -o bdd2.png");
    if (result != 0) {
        fprintf(stderr, "Error converting DOT to PNG\n");
    } else {
        printf("BDD image saved as bdd2.png\n");
    }
