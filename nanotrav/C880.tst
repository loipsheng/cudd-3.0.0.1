...
Number of cache look-ups: 59181
Number of cache hits: 28649
Number of cache insertions: 30613
Number of cache collisions: 2563
Number of cache deletions: 28050
Cache used slots = 18.08% (expected 0.00%)
Soft limit for cache size: 62464
Number of buckets in unique table: 15616
Used buckets in unique table: 21.20% (expected 20.96%)
...
Maximum resident size            =  6260K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1626
Swaps = 0
Input blocks = 0
Output blocks = 8
